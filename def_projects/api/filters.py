...
# creating custom filter for blogs model which helps to filter blogs based on title 

class BloggFilter(django_filters.FilterSet):
    blogger_name = django_filters.CharFilter(field_name='blogger_name', lookup_expr='iexact')
